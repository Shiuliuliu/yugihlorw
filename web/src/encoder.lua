...
SInt32Sizer = _ModifiedSizer(_SignedVarintSize, var_0_5.ZigZagEncode)
...
SInt64Encoder = _ModifiedEncoder(var_0_5.WIRETYPE_VARINT, var_0_6, _VarintSize, var_0_5.ZigZagEncode64)
