...
function var_0_0.setOrCreateItem(arg_9_0, arg_9_1, arg_9_2)
	...
	if var_9_13._trophyArea then
		var_9_13._trophyArea._label:setString(string.format("%d", (var_9_14 and var_9_14._trophy) or 800))
		local tChg = math.abs(arg_9_2._trophy or 0)
		var_9_13._trophyChange:setString(string.format("%s%d", (var_9_15 ~= Data.BattleResult.lose and "+" or "-"), tChg))
	end
