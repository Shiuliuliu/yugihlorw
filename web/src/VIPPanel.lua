local var_0_0 = class("VIPPanel", lc.ExtendUIWidget)
...
function var_0_0.init(arg_2_0, arg_2_1)
	...
	local var_2_2 = ClientView.createCheckinTitle(Str(STR.VIP_CHECKIN_TITLE), 0)

	lc.addChildToPos(arg_2_0, var_2_2, cc.p(lc.w(arg_2_0) / 2 + 140, lc.h(arg_2_0) - lc.h(var_2_2) / 2 - 24))

	local var_2_3 = ClientView.createTTF(Str(STR.VIP_CHECKIN_TIP), ClientView.FontSize.S1, ClientView.COLOR_TEXT_DARK)
	...
	local var_2_6 = {}
	local var_2_7, var_2_8, var_2_9 = P._playerBonus.splitBonus(P._playerBonus._bonusVipDaily, function(arg_3_0, arg_3_1)
		return {
			_bonus = arg_3_1,
			_label = string.format("VIP %d", arg_3_0)
		}
	end)
