...
function var_0_0.addCardList(arg_9_0)
	...
	for iter_9_0 = 1, table.maxn(var_9_3) do
		...
		if var_9_5 then
			...
			if var_9_16 then
				local var_9_17 = Data._globalInfo._magicShopDiscountMonth
				local var_9_18 = 0

				for iter_9_1, iter_9_2 in ipairs(var_9_17) do
					if iter_9_2 <= var_9_15 then
						var_9_18 = iter_9_1
					end

					if var_9_15 <= iter_9_2 then
						break
					end
				end
	...
	var_9_0._pageLeft._pos = cc.p(-var_9_20, lc.ch(var_9_0))
	var_9_0._pageRight._pos = cc.p(lc.w(var_9_0) + var_9_20, lc.ch(var_9_0))
