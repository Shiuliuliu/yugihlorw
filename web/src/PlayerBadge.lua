local var_0_0 = class("PlayerBadge")
...
function var_0_0.init(arg_4_0, arg_4_1)
	arg_4_0._grade = arg_4_1.badge_level
	arg_4_0._isBuyBadge = arg_4_1.badge_purchased
	arg_4_0._starNum = arg_4_1.badge_exp
	arg_4_0._starTotal = Data._globalInfo._badgeExpPerLevel
	arg_4_0._curStage = arg_4_1.badge_season or 1
	arg_4_0._endTime = arg_4_1.badge_end_timestamp / 1000
	...
	for iter_4_0, iter_4_1 in pairs(Data._battlepassTask) do
		local var_4_2 = false
		local var_4_3 = 0
...
function var_0_0.refreshBonusValue(arg_5_0)
	for iter_5_0 = 1, #P._playerBonus._bonusBadge do
		P._playerBonus._bonusBadge[iter_5_0]:setValue(arg_5_0._grade)
	end
end
...
function var_0_0.getDayStar(arg_15_0, arg_15_1)
	...
	for iter_15_0, iter_15_1 in pairs(Data._battlepassTask) do
...
function var_0_0.getBadgeClaimFlag(arg_18_0)
	for iter_18_0 = 1, #P._playerBonus._bonusBadge do
		local var_18_0 = P._playerBonus._bonusBadge[iter_18_0]
		...
		elseif var_18_1 == 56 and arg_18_0:IsBuyBadge() and var_18_0:canClaim() then
			return true
		end
	end
