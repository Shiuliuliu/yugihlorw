...
function var_0_0.getTeachPassed(arg_16_0, arg_16_1, arg_16_2)
	...
	for iter_16_0, iter_16_1 in pairs(arg_16_0._teachInfos[arg_16_1]) do
		local var_16_1 = P and P._playerBonus and P._playerBonus._bonusTeach and P._playerBonus._bonusTeach[iter_16_1._bonusId]
...
function var_0_0.refreshList(arg_18_0)
	...
	local function var_18_1(arg_19_0, arg_19_1)
		local var_19_0 = P and P._playerBonus and P._playerBonus._bonusTeach and P._playerBonus._bonusTeach[arg_19_0._bonusId]
		local var_19_1 = P and P._playerBonus and P._playerBonus._bonusTeach and P._playerBonus._bonusTeach[arg_19_1._bonusId]
...
function var_0_0.setOrCreateItem(arg_21_0, arg_21_1, arg_21_2)
	local var_21_0 = P and P._playerBonus and P._playerBonus._bonusTeach and P._playerBonus._bonusTeach[arg_21_2._bonusId]
	if not var_21_0 then
		var_21_0 = { _info = Data._bonusInfo and Data._bonusInfo[arg_21_2._bonusId] or { _val = 1, _type = Data.BonusType.teach }, _value = 0, _isClaimed = false }
	end
...
function var_0_0.isLastTeachPass(arg_24_0, arg_24_1)
	...
	local var_24_1 = Data._teachInfo and Data._teachInfo[var_24_0]
	if not var_24_1 then return true end
	local var_24_2 = P and P._playerBonus and P._playerBonus._bonusTeach and P._playerBonus._bonusTeach[var_24_1._bonusId]
	if not var_24_2 then return true end

	return var_24_2._value >= (var_24_2._info and var_24_2._info._val or 1)
end
