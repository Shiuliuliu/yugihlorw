local var_0_0 = class("BadgeForm", BaseForm)
...
function var_0_0.init(arg_2_0)
	...
	lc.addChildToPos(var_2_4, var_2_6, cc.p(lc.cw(var_2_4), lc.ch(var_2_6) + 23), -1)

	arg_2_0._bottom = var_2_6
...
function var_0_0.addBadgeArea(arg_5_0)
	...
	local var_5_2 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.BADGE_GRADE) .. P._playerBadge:getGrade())
	...
	local var_5_3 = ClientData.getIconName(Data.ResType.badge_star, false)
	...
	var_5_5:setVisible(not (P._playerBadge:getGrade() >= 100))
	var_5_5:setAnchorPoint(0, 0.5)
	var_5_5._bar:setPercent(P._playerBadge:getCurStarNum() / P._playerBadge:getStarTotal() * 100)
	var_5_5._label:setString(P._playerBadge:getCurStarNum() .. "/" .. P._playerBadge:getStarTotal())
	...
	var_5_6:setVisible(P._playerBadge:getGrade() >= 100)
	lc.addChildToPos(var_5_1, var_5_6, cc.p(lc.right(var_5_4) + 65, lc.ch(var_5_4)))

	arg_5_0._maxTxt = var_5_6

	local var_5_7 = ClientView.createBMFont(ClientView.BMFont.huali_32, string.format(Str(STR.STAGE_COUNT), P._playerBadge:getCurStage()))

	lc.addChildToPos(var_5_1, var_5_7, cc.p(lc.w(var_5_1) - 200, lc.h(var_5_1) - lc.ch(var_5_7) - 5))

	local var_5_8, var_5_9 = P._playerBadge:getCountDown()
	...
	local var_5_13 = lc.createSprite("img_silver_badge")

	lc.addChildToPos(var_5_12, var_5_13, cc.p(lc.cw(var_5_12) - 5, lc.h(var_5_12) - lc.ch(var_5_13) - 1))

	local var_5_14 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.FREE_BADGE))

	var_5_14:setScale(0.8)
	var_5_14:setColor(cc.c3b(148, 226, 255))
	lc.addChildToPos(var_5_12, var_5_14, cc.p(lc.cw(var_5_12) - 5, lc.bottom(var_5_13) - 30))
	...
	local var_5_16 = lc.createSprite("img_gold_badge")

	lc.addChildToPos(var_5_15, var_5_16, cc.p(lc.cw(var_5_15) - 5, lc.h(var_5_15) - lc.ch(var_5_16) - 1))

	local var_5_17 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.BADGE_SYSTEM))

	var_5_17:setScale(0.8)
	var_5_17:setColor(cc.c3b(255, 254, 198))
	lc.addChildToPos(var_5_15, var_5_17, cc.p(lc.cw(var_5_15) - 5, lc.bottom(var_5_16) - 30))

	local var_5_18 = lc.createSprite("img_lock_1")

	var_5_18:setVisible(not P._playerBadge:IsBuyBadge())
	...
	var_5_19:addLabel(Str(STR.BUY) .. Str(STR.BADGE_SYSTEM))
	var_5_19:setVisible(not P._playerBadge:IsBuyBadge())
	lc.addChildToPos(var_5_0, var_5_19, cc.p(180, lc.ch(var_5_19) + 30))

	arg_5_0._buyBtn = var_5_19

	local var_5_20 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.BUY_BADGE_TIP))

	var_5_20:setScale(0.9)
	var_5_20:setColor(cc.c3b(148, 226, 255))
	var_5_20:setVisible(not P._playerBadge:IsBuyBadge())
	...
	var_5_21:setVisible(P._playerBadge:IsBuyBadge())
	...
	for iter_5_0 = 1, #P._playerBonus._bonusBadge do
		local var_5_25 = P._playerBonus._bonusBadge[iter_5_0]

		if var_5_25._type == 55 then
			table.insert(arg_5_0._freeRewards, var_5_25)
		elseif var_5_25._type == 56 then
...
function var_0_0.createItemList(arg_10_0)
	...
	arg_10_0._curPage = P._playerBadge:getGrade() % var_0_9 == 0 and math.floor(P._playerBadge:getGrade() / var_0_9) or math.floor(P._playerBadge:getGrade() / var_0_9) + 1
...
function var_0_0.updateRewardList(arg_15_0)
	...
	arg_15_0._gradeTxt:setString(Str(STR.BADGE_GRADE) .. P._playerBadge:getGrade())
	arg_15_0._buyBtn:setVisible(not P._playerBadge:IsBuyBadge())
	arg_15_0._tip:setVisible(not P._playerBadge:IsBuyBadge())
	arg_15_0._privilegeBtn:setVisible(P._playerBadge:IsBuyBadge())
	arg_15_0._proBottom._bar:setPercent(P._playerBadge:getCurStarNum() / P._playerBadge:getStarTotal() * 100)
	arg_15_0._proBottom._label:setString(P._playerBadge:getCurStarNum() .. "/" .. P._playerBadge:getStarTotal())
	arg_15_0._proBottom:setVisible(not (P._playerBadge:getGrade() >= 100))
	arg_15_0._maxTxt:setVisible(P._playerBadge:getGrade() >= 100)
	arg_15_0._claimAllBtn:setVisible(P._playerBadge:IsBuyBadge())
	arg_15_0._claimAllBtn:setEnabled(P._playerBadge:getBadgeClaimFlag())
	...
	for iter_15_0 = 1, #arg_15_0._tabTable do
		...
		if var_15_0 == P._playerBadge:getGrade() then
	...
	for iter_15_1 = 1, #arg_15_0._freeItems do
		...
		if var_15_2 > 100 then
			...
			if var_15_2 > P._playerBadge:getGrade() then
	...
	for iter_15_2 = 1, #arg_15_0._noFreeItems do
		...
		if var_15_5 > 100 then
			...
			if P._playerBadge:IsBuyBadge() then
				if var_15_5 > P._playerBadge:getGrade() then
...
function var_0_0.addTaskArea(arg_16_0)
	...
	for iter_16_0 = 1, 7 do
		...
		local var_16_5 = ClientData.getIconName(Data.ResType.badge_star, false)
		...
		local var_16_7, var_16_8 = P._playerBadge:getDayStar(iter_16_0)
	...
	local var_16_11 = lc.createSprite("img_silver_badge")

	lc.addChildToPos(var_16_10, var_16_11, cc.p(lc.cw(var_16_10) - 5, lc.h(var_16_10) - lc.ch(var_16_11) - 1))

	local var_16_12 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.FREE_BADGE))

	var_16_12:setScale(0.8)
	var_16_12:setColor(cc.c3b(148, 226, 255))
	lc.addChildToPos(var_16_10, var_16_12, cc.p(lc.cw(var_16_10) - 5, lc.bottom(var_16_11) - 30))
	...
	local var_16_14 = lc.createSprite("img_gold_badge")

	lc.addChildToPos(var_16_13, var_16_14, cc.p(lc.cw(var_16_13) - 5, lc.h(var_16_13) - lc.ch(var_16_14) - 1))

	local var_16_15 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.BADGE_SYSTEM))

	var_16_15:setScale(0.8)
	var_16_15:setColor(cc.c3b(255, 254, 198))
	lc.addChildToPos(var_16_13, var_16_15, cc.p(lc.cw(var_16_13) - 5, lc.bottom(var_16_14) - 30))

	local var_16_16 = lc.createSprite("img_lock_1")

	var_16_16:setVisible(not P._playerBadge:IsBuyBadge())
	...
	var_16_17:addLabel(Str(STR.BUY) .. Str(STR.BADGE_SYSTEM))
	var_16_17:setVisible(not P._playerBadge:IsBuyBadge())
	lc.addChildToPos(var_16_0, var_16_17, cc.p(180, lc.ch(var_16_17) + 30))

	arg_16_0._buyBtn1 = var_16_17

	local var_16_18 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.TASK_BADGE_TIP))

	var_16_18:setScale(0.9)
	var_16_18:setColor(cc.c3b(148, 226, 255))
	var_16_18:setVisible(not P._playerBadge:IsBuyBadge())
	...
	var_16_19:setVisible(P._playerBadge:IsBuyBadge())
	...
	local function var_16_22(arg_20_0)
		for iter_20_0, iter_20_1 in pairs(Data._battlepassTask) do
	...
	var_16_22(P._playerBadge:getCurStage())
	...
	for iter_16_1 = 1, 2 do
		...
		local var_16_26 = IconWidget.create({
			_count = 50,
			_infoId = Data.ResType.badge_star
...
function var_0_0.updateTask(arg_23_0, arg_23_1)
	arg_23_0._buyBtn1:setVisible(not P._playerBadge:IsBuyBadge())
	arg_23_0._tip1:setVisible(not P._playerBadge:IsBuyBadge())
	arg_23_0._privilegeBtn1:setVisible(P._playerBadge:IsBuyBadge())
	...
	for iter_23_1 = 1, #arg_23_0._freeTask do
		...
		if arg_23_1 > arg_23_0._weekDay then
			...
			local var_23_4 = P._playerBadge._badgeTask[var_23_3._id]:getValue()
			...
			if var_23_4 >= var_23_3._value then
				...
				if P._playerBadge._badgeTask[var_23_3._id]:isClaim() then
	...
	for iter_23_2 = 1, #arg_23_0._task do
		...
		if arg_23_1 > arg_23_0._weekDay then
			...
			local var_23_7 = P._playerBadge._badgeTask[var_23_6._id]:getValue()
			...
			if P._playerBadge:IsBuyBadge() then
				if var_23_7 >= var_23_6._value then
					...
					if P._playerBadge._badgeTask[var_23_6._id]:isClaim() then
...
function var_0_0.addBuyArea(arg_24_0)
	...
	for iter_24_0 = 1, 2 do
		...
		local var_24_2 = iter_24_0 == 1 and cc.p(lc.w(arg_24_0._buyBadgeArea) / 4, lc.ch(arg_24_0._buyBadgeArea)) or cc.p(lc.w(arg_24_0._buyBadgeArea) * 0.75, lc.ch(arg_24_0._buyBadgeArea))
		...
		local var_24_4 = lc.createSprite("img_gold_badge")

		lc.addChildToPos(var_24_3, var_24_4, cc.p(lc.w(var_24_3) / 4 - 20, lc.h(var_24_3) - lc.ch(var_24_4)))

		local var_24_5 = lc.createSprite("img_add")

		lc.addChildToCenter(var_24_3, var_24_5)

		local var_24_6 = iter_24_0 == 1 and "img_little_star" or "img_big_star"
		local var_24_7 = lc.createSprite(var_24_6)

		lc.addChildToPos(var_24_3, var_24_7, cc.p(lc.w(var_24_3) * 0.75 + 13, lc.ch(var_24_3) + 8))

		local var_24_8 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.BADGE_SYSTEM))

		var_24_8:setScale(0.8)
		var_24_8:setColor(cc.c3b(255, 254, 198))
		lc.addChildToPos(var_24_3, var_24_8, cc.p(lc.w(var_24_3) / 4 - 20, lc.ch(var_24_8) + 10))

		local var_24_9 = ClientView.createBMFont(ClientView.BMFont.huali_26, string.format(Str(STR.BADGE_STAR), 30 * Data._globalInfo._badgeBuyLevel[iter_24_0]))

		var_24_9:setScale(0.8)
		var_24_9:setColor(cc.c3b(255, 254, 198))
		lc.addChildToPos(var_24_3, var_24_9, cc.p(lc.w(var_24_3) * 0.75 + 13, lc.ch(var_24_9) + 10))

		local var_24_10 = iter_24_0 == 1 and Str(STR.BUY_BADGE_DESC_1, true) or Str(STR.BUY_BADGE_DESC_2, true)
		local var_24_11 = ClientView.createTTF(var_24_10, ClientView.FontSize.S3)

		var_24_11:setAnchorPoint(cc.p(0, 0.5))
		lc.addChildToPos(var_24_1, var_24_11, cc.p(40, lc.ch(var_24_1) - 60))

		local var_24_12 = ClientView.createScale9ShaderButton("img_btn_1_s", function(arg_25_0)
			arg_24_0:onBuyBadge(arg_25_0, iter_24_0)
		end, ClientView.CRECT_BUTTON, 220, 70)

		var_24_12:addLabel(Str(STR.BUY))
		lc.addChildToPos(var_24_1, var_24_12, cc.p(lc.cw(var_24_1), lc.ch(var_24_12) + 30))
		ClientView.addPriceToBtn(var_24_12, Data._globalInfo._badgeBuyIngot[iter_24_0], Data.ResType.ingot, 100, 30)
		lc.offset(var_24_12._label, -60, -3)
		lc.offset(var_24_12._resNumLabel, 30, -3)
		lc.offset(var_24_12._resIcon, 30, -3)
	end
	...
	for iter_24_1 = 1, 3 do
		local var_24_13 = lc.createSprite({
			_name = "img_buybadge_bottom",
			_crect = cc.rect(48, 0, 1, 603),
			_size = cc.size(310, 603)
		})

		lc.addChildToPos(arg_24_0._buyStarArea, var_24_13, cc.p(lc.w(arg_24_0._buyStarArea) / 5 - 18 + (iter_24_1 - 1) * (lc.w(var_24_13) + 15), lc.ch(arg_24_0._buyStarArea)))

		local var_24_14 = lc.createSprite({
			_name = "img_star_bottom",
			_crect = cc.rect(29, 0, 1, 193),
			_size = cc.size(250, 193)
		})

		lc.addChildToPos(var_24_13, var_24_14, cc.p(lc.cw(var_24_13), lc.h(var_24_13) - lc.ch(var_24_14) - 25))

		local var_24_15 = "img_little_star"

		if iter_24_1 == 2 then
			var_24_15 = "img_mid_star"
		elseif iter_24_1 == 3 then
			var_24_15 = "img_big_star"
		end

		local var_24_16 = lc.createSprite(var_24_15)

		lc.addChildToPos(var_24_14, var_24_16, cc.p(lc.cw(var_24_14), lc.ch(var_24_14) + 10))

		local var_24_17 = ClientView.createBMFont(ClientView.BMFont.huali_26, string.format(Str(STR.BADGE_STAR), 30 * Data._globalInfo._badgeUpgradeLevel[iter_24_1]))

		var_24_17:setScale(0.8)
		var_24_17:setColor(cc.c3b(255, 254, 198))
		lc.addChildToPos(var_24_14, var_24_17, cc.p(lc.cw(var_24_14), lc.ch(var_24_17) + 10))

		local var_24_18 = Str(STR.BUY_STAR_DESC_1, true)

		if iter_24_1 == 2 then
			var_24_18 = Str(STR.BUY_STAR_DESC_2, true)
		elseif iter_24_1 == 3 then
			var_24_18 = Str(STR.BUY_STAR_DESC_3, true)
		end

		local var_24_19 = ClientView.createTTF(var_24_18, ClientView.FontSize.S3)

		var_24_19:setAnchorPoint(cc.p(0, 0.5))
		lc.addChildToPos(var_24_13, var_24_19, cc.p(30, lc.ch(var_24_13) - 60))

		local var_24_20 = ClientView.createScale9ShaderButton("img_btn_1_s", function()
			arg_24_0:onBuyBadgeStar(iter_24_1)
		end, ClientView.CRECT_BUTTON, 220, 70)

		var_24_20:addLabel(Str(STR.BUY))
		lc.addChildToPos(var_24_13, var_24_20, cc.p(lc.cw(var_24_13), lc.ch(var_24_20) + 30))
		ClientView.addPriceToBtn(var_24_20, Data._globalInfo._badgeUpgradeIngot[iter_24_1], Data.ResType.ingot, 100, 30)
		lc.offset(var_24_20._label, -60, -3)
		lc.offset(var_24_20._resNumLabel, 30, -3)
		lc.offset(var_24_20._resIcon, 30, -3)
	end
end

function var_0_0.addHelpArea(arg_27_0)
	local var_27_0 = Data.getHelpStrsByType(Data.HelpType.badge)
...
function var_0_0.privilegeShow(arg_28_0, arg_28_1, arg_28_2)
	...
	if P:getItemCount(Data.PropsId.union_battle_exp) > 0 then
		table.insert(var_28_1, var_28_2(string.format(Str(STR.PRIVILEGE_DESC_1), P:getItemCount(Data.PropsId.union_battle_exp))))
	end

	if P:getItemCount(Data.PropsId.badge_extend_task) > 0 then
		table.insert(var_28_1, var_28_2(Str(STR.PRIVILEGE_DESC_2)))
	end

	if P:getItemCount(Data.PropsId.hall_star) > 0 then
		table.insert(var_28_1, var_28_2(Str(STR.PRIVILEGE_DESC_3)))
	end

	if P:getItemCount(Data.PropsId.union_star) > 0 then
		table.insert(var_28_1, var_28_2(Str(STR.PRIVILEGE_DESC_4)))
	end
...
function var_0_0.showTab(arg_32_0, arg_32_1)
	...
	elseif arg_32_1 == 3 then
		arg_32_0._buyStarArea:setVisible(P._playerBadge:IsBuyBadge())
		arg_32_0._buyBadgeArea:setVisible(not P._playerBadge:IsBuyBadge())
...
function var_0_0.onClaim(arg_33_0, arg_33_1)
	...
	if var_33_0 == Data.ErrorType.ok then
		...
		lc.sendEvent(Data.Event.badge_reward)
	end
end

function var_0_0.onClaimAll(arg_34_0)
	local var_34_0 = P._playerBonus._bonusBadge
	local var_34_1 = {}
...
function var_0_0.onClaimStar(arg_35_0, arg_35_1)
	...
	P._playerBadge._badgeTask[arg_35_1._taskId]:setClaim(true)

	local var_35_0, var_35_1 = P._playerBadge:getDayStar(arg_35_1._day)

	arg_35_0._days[arg_35_1._day]._txtObj:setString(var_35_0 .. "/" .. var_35_1)
	ClientData.sendClaimActivityBonus(arg_35_1._taskId)

	local var_35_2 = Data._battlepassTask[arg_35_1._taskId]._num + P:getItemCount(Data.PropsId.badge_extend_task) * 6
...
function var_0_0.onBuyBadge(arg_36_0, arg_36_1, arg_36_2)
	if P:hasResource(Data.ResType.ingot, Data._globalInfo._badgeBuyIngot[arg_36_2]) then
		arg_36_1:setEnabled(false)
		P._playerBadge:setBuyBadgeStatus(true)
		P._playerBadge:addGrade(Data._globalInfo._badgeBuyLevel[arg_36_2])
		arg_36_0._contentBg:showTab(1, true)
		arg_36_0._lock:setVisible(false)
		arg_36_0._taskBadgeLock:setVisible(false)
		P:addResource(Data.ResType.ingot, 0, -Data._globalInfo._badgeBuyIngot[arg_36_2])
		ClientData.sendBuyBadge(arg_36_2)
...
function var_0_0.onBuyBadgeStar(arg_37_0, arg_37_1)
	if P._playerBadge:getGrade() >= 100 then
		return ToastManager.push(Str(STR.MAX_BADGE_GRADE))
	end

	if P:hasResource(Data.ResType.ingot, Data._globalInfo._badgeUpgradeIngot[arg_37_1]) then
		P:addResource(Data.ResType.ingot, 0, -Data._globalInfo._badgeUpgradeIngot[arg_37_1])
		ClientData.sendBuyBadgeStar(arg_37_1)
		ToastManager.push(Str(STR.BUYSUCCESS))

		local var_37_0 = Data._globalInfo._badgeUpgradeLevel[arg_37_1] * P._playerBadge:getStarTotal()
...
function var_0_0.onEnter(arg_38_0)
	var_0_0.super.onEnter(arg_38_0)
	arg_38_0:setCameraMask(ClientData.CAMERA_2D_FLAG)
	arg_38_0:updateBadgeFlag()
	arg_38_0:updateTaskFlag()
	arg_38_0:updateTaskTabFlag()

	arg_38_0._listeners = {}

	table.insert(arg_38_0._listeners, lc.addEventListener(Data.Event.badge_reward, function()
		arg_38_0:updateBadgeFlag()
		arg_38_0:updateTaskFlag()
		arg_38_0:updateTaskTabFlag()
	end))
...
function var_0_0.onExit(arg_40_0)
	var_0_0.super.onExit(arg_40_0)

	for iter_40_0, iter_40_1 in ipairs(arg_40_0._listeners) do
		lc.Dispatcher:removeEventListener(iter_40_1)
	end

	ClientData.removeMsgListener(arg_40_0)
end
...
function var_0_0.onCleanup(arg_42_0)
	var_0_0.super.onCleanup(arg_42_0)
	ClientData.unloadLCRes(arg_42_0._resNames)
end

function var_0_0.updateBadgeFlag(arg_43_0)
	local var_43_0 = P._playerBadge:getBadgeClaimFlag()

	ClientView.checkNewFlag(arg_43_0._contentBg._tabs[1], var_43_0, 15, -15)
end

function var_0_0.updateTaskFlag(arg_44_0)
	local var_44_0 = P._playerBadge:getTaskClaimFlag()

	ClientView.checkNewFlag(arg_44_0._contentBg._tabs[2], var_44_0, 15, -15)
end

function var_0_0.updateTaskTabFlag(arg_45_0)
	for iter_45_0 = 1, #arg_45_0._days do
		local var_45_0 = arg_45_0._days[iter_45_0]
		local var_45_1 = P._playerBadge:getOneDayTaskClaimFlag(iter_45_0)

		ClientView.checkNewFlag(var_45_0, var_45_1, 15, -5)
	end
end

function var_0_0.onMsg(arg_46_0, arg_46_1)
	if arg_46_1.type == SglMsgType_pb.PB_TYPE_BONUS_PLAYER_ACTIVITY_BONUS then
		if arg_46_0._indicator then
			arg_46_0._indicator:removeFromParent()

			arg_46_0._indicator = nil
		end

		arg_46_0._contentBg:showTab(1, true)
	end
