local var_0_0 = class("NewShopArea", lc.ExtendCCNode)
...
function var_0_0.generateCardPackageData(arg_6_0)
	local var_6_0 = Data._newProductsInfo
	local var_6_1 = {}
	local var_6_2 = {}
...
function var_0_0.createRecruitItem(arg_8_0, arg_8_1)
	...
	local var_8_1 = ClientView.createNewCardPackage(arg_8_1)
...
function var_0_0.showCardBox(arg_14_0, arg_14_1)
	...
	ClientView.getResourceUI():setMode(Data.PropsId.new_token, 2)
end
...
function var_0_0.addCardList(arg_18_0, arg_18_1, arg_18_2)
	...
	local function var_18_4(arg_19_0)
		...
		ClientData.sendBuyNew(var_19_0._id)
