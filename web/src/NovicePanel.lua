local var_0_0 = class("NovicePanel", lc.ExtendUIWidget)
...
function var_0_0.init(arg_2_0, arg_2_1)
	...
	local var_2_2 = ClientView.createCheckinTitle(Str(STR.NOVICE_CHECKIN_TITLE), 0)
	...
	lc.addChildToPos(arg_2_0, var_2_3, cc.p(lc.w(arg_2_0) / 2, lc.h(var_2_3) / 2))

	local var_2_4 = lc.List.createV(cc.size(lc.w(var_2_3) - 32, lc.h(var_2_3) - 20), 16, 10)

	lc.addChildToPos(var_2_3, var_2_4, cc.p(16, 10))

	local var_2_5 = {}
	local var_2_6, var_2_7, var_2_8 = P._playerBonus.splitBonus(P._playerBonus._bonusLogin, function(arg_3_0, arg_3_1)
		return {
			_bonus = arg_3_1,
			_label = string.format(Str(STR.DATE_NUM), arg_3_1._info._val)
		}
	end)
	...
	for iter_2_2, iter_2_3 in ipairs(var_2_8) do
		table.insert(var_2_5, iter_2_3)
	end

	for iter_2_4, iter_2_5 in ipairs(var_2_7) do
		table.insert(var_2_5, iter_2_5)
	end

	var_2_4:bindData(var_2_5, function(arg_4_0, arg_4_1)
		arg_4_0:updateData(arg_4_1._label, arg_4_1._bonus)
	end, math.min(4, #var_2_5))

	for iter_2_6 = 1, var_2_4._cacheCount do
		local var_2_9 = var_0_1.create(var_2_5[iter_2_6]._label, var_2_5[iter_2_6]._bonus)

		var_2_9:registerClaimHandler(function(arg_5_0)
			local var_5_0 = ClientData.claimBonus(arg_5_0)

			ClientView.showClaimBonusResult(arg_5_0, var_5_0)
		end)
		var_2_4:pushBackCustomItem(var_2_9)
	end
end
