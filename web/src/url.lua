...
function var_0_4.absolute(arg_22_0, arg_22_1)
	if var_0_1.type(arg_22_0) == "table" then
		base_parsed = arg_22_0
		arg_22_0 = var_0_4.build(base_parsed)
	else
		base_parsed = var_0_4.parse(arg_22_0)
	end

	local var_22_0 = var_0_4.parse(arg_22_1)

	if not base_parsed then
		return arg_22_1
	elseif not var_22_0 then
		return arg_22_0
	elseif var_22_0.scheme then
		return arg_22_1
	else
		var_22_0.scheme = base_parsed.scheme

		if not var_22_0.authority then
			var_22_0.authority = base_parsed.authority

			if not var_22_0.path then
				var_22_0.path = base_parsed.path

				if not var_22_0.params then
					var_22_0.params = base_parsed.params

					if not var_22_0.query then
						var_22_0.query = base_parsed.query
					end
				end
			else
				var_22_0.path = var_0_7(base_parsed.path or "", var_22_0.path)
			end
		end

		return var_0_4.build(var_22_0)
	end
end
