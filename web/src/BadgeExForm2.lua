...
function var_0_0.init(arg_2_0)
	...
	local var_2_1 = {
		Str(STR.FREE_BADGE_EX2),
		Str(STR.BADGE_TASK_EX2),
		Str(STR.BUY),
		Str(STR.HELP)
	}
	local var_2_2 = {}
	...
	local var_2_6 = lc.createSprite("res/jpg/img_badge_bg_ex2.jpg")
...
function var_0_0.addBadgeArea(arg_5_0)
	...
	local var_5_2 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.BADGE_GRADE) .. P._playerBadgeEx2:getGrade())
	...
	local var_5_3 = ClientData.getIconName(Data.ResType.badge_star_ex2, false)
	...
	var_5_5:setVisible(not (P._playerBadgeEx2:getGrade() >= 100))
	var_5_5:setAnchorPoint(0, 0.5)
	var_5_5._bar:setPercent(P._playerBadgeEx2:getCurStarNum() / P._playerBadgeEx2:getStarTotal() * 100)
	var_5_5._label:setString(P._playerBadgeEx2:getCurStarNum() .. "/" .. P._playerBadgeEx2:getStarTotal())
	...
	var_5_6:setVisible(P._playerBadgeEx2:getGrade() >= 100)
	...
	local var_5_8, var_5_9 = P._playerBadgeEx2:getCountDown()
	...
	local var_5_13 = lc.createSprite("img_silver_badge_ex2")

	lc.addChildToPos(var_5_12, var_5_13, cc.p(lc.cw(var_5_12) - 3, lc.h(var_5_12) - lc.ch(var_5_13) - 3))

	local var_5_14 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.FREE_BADGE_EX2))
	...
	local var_5_16 = lc.createSprite("img_gold_badge_ex2")

	lc.addChildToPos(var_5_15, var_5_16, cc.p(lc.cw(var_5_15) - 3, lc.h(var_5_15) - lc.ch(var_5_16) - 3))

	local var_5_17 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.BADGE_SPRING2))
	...
	var_5_18:setVisible(not P._playerBadgeEx2:IsBuyBadge())
	...
	var_5_19:addLabel(Str(STR.BUY) .. Str(STR.BADGE_SPRING2))
	var_5_19:setVisible(not P._playerBadgeEx2:IsBuyBadge())
	lc.addChildToPos(var_5_0, var_5_19, cc.p(180, lc.ch(var_5_19) + 30))

	arg_5_0._buyBtn = var_5_19

	local var_5_20 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.BUY_BADGE_TIP_EX2))

	var_5_20:setScale(0.9)
	var_5_20:setColor(cc.c3b(148, 226, 255))
	var_5_20:setVisible(not P._playerBadgeEx2:IsBuyBadge())
	...
	var_5_21:setVisible(P._playerBadgeEx2:IsBuyBadge())
	...
	for iter_5_0 = 1, #P._playerBonus._bonusBadgeEx2 do
		local var_5_25 = P._playerBonus._bonusBadgeEx2[iter_5_0]

		if var_5_25._type == 62 then
			table.insert(arg_5_0._freeRewards, var_5_25)
		elseif var_5_25._type == 63 then
...
function var_0_0.createItemList(arg_10_0)
	...
	arg_10_0._curPage = P._playerBadgeEx2:getGrade() % var_0_9 == 0 and math.floor(P._playerBadgeEx2:getGrade() / var_0_9) or math.floor(P._playerBadgeEx2:getGrade() / var_0_9) + 1
...
function var_0_0.updateRewardList(arg_15_0)
	...
	arg_15_0._gradeTxt:setString(Str(STR.BADGE_GRADE_EX2) .. P._playerBadgeEx2:getGrade())
	arg_15_0._buyBtn:setVisible(not P._playerBadgeEx2:IsBuyBadge())
	arg_15_0._tip:setVisible(not P._playerBadgeEx2:IsBuyBadge())
	arg_15_0._privilegeBtn:setVisible(P._playerBadgeEx2:IsBuyBadge())
	arg_15_0._proBottom._bar:setPercent(P._playerBadgeEx2:getCurStarNum() / P._playerBadgeEx2:getStarTotal() * 100)
	arg_15_0._proBottom._label:setString(P._playerBadgeEx2:getCurStarNum() .. "/" .. P._playerBadgeEx2:getStarTotal())
	arg_15_0._proBottom:setVisible(not (P._playerBadgeEx2:getGrade() >= 100))
	arg_15_0._maxTxt:setVisible(P._playerBadgeEx2:getGrade() >= 100)
	arg_15_0._claimAllBtn:setVisible(P._playerBadgeEx2:IsBuyBadge())
	arg_15_0._claimAllBtn:setEnabled(P._playerBadgeEx2:getBadgeClaimFlag())
	...
	for iter_15_0 = 1, #arg_15_0._tabTable do
		...
		if var_15_0 == P._playerBadgeEx2:getGrade() then
	...
	for iter_15_1 = 1, #arg_15_0._freeItems do
		...
		if var_15_2 > 100 then
			...
			if var_15_2 > P._playerBadgeEx2:getGrade() then
	...
	for iter_15_2 = 1, #arg_15_0._noFreeItems do
		...
		if var_15_5 > 100 then
			...
			if P._playerBadgeEx2:IsBuyBadge() then
				if var_15_5 > P._playerBadgeEx2:getGrade() then
...
function var_0_0.addTaskArea(arg_16_0)
	...
	for iter_16_0 = 1, 7 do
		...
		local var_16_5 = ClientData.getIconName(Data.ResType.badge_star_ex2, false)
		...
		local var_16_7, var_16_8 = P._playerBadgeEx2:getDayStar(iter_16_0)
	...
	local var_16_11 = lc.createSprite("img_silver_badge_ex2")

	lc.addChildToPos(var_16_10, var_16_11, cc.p(lc.cw(var_16_10) - 3, lc.h(var_16_10) - lc.ch(var_16_11) - 3))

	local var_16_12 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.FREE_BADGE_EX2))
	...
	local var_16_14 = lc.createSprite("img_gold_badge_ex2")

	lc.addChildToPos(var_16_13, var_16_14, cc.p(lc.cw(var_16_13) - 3, lc.h(var_16_13) - lc.ch(var_16_14) - 3))

	local var_16_15 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.BADGE_SPRING2))
	...
	var_16_16:setVisible(not P._playerBadgeEx2:IsBuyBadge())
	...
	var_16_17:addLabel(Str(STR.BUY) .. Str(STR.BADGE_SPRING2))
	var_16_17:setVisible(not P._playerBadgeEx2:IsBuyBadge())
	lc.addChildToPos(var_16_0, var_16_17, cc.p(180, lc.ch(var_16_17) + 30))

	arg_16_0._buyBtn1 = var_16_17

	local var_16_18 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.TASK_BADGE_TIP_EX2))

	var_16_18:setScale(0.9)
	var_16_18:setColor(cc.c3b(148, 226, 255))
	var_16_18:setVisible(not P._playerBadgeEx2:IsBuyBadge())
	...
	var_16_19:setVisible(P._playerBadgeEx2:IsBuyBadge())
	...
	var_16_22(P._playerBadgeEx2:getCurStage())
	...
	for iter_16_1 = 1, 2 do
		...
		local var_16_26 = IconWidget.create({
			_count = 50,
			_infoId = Data.ResType.badge_star_ex2
...
function var_0_0.updateTask(arg_23_0, arg_23_1)
	arg_23_0._buyBtn1:setVisible(not P._playerBadgeEx2:IsBuyBadge())
	arg_23_0._tip1:setVisible(not P._playerBadgeEx2:IsBuyBadge())
	arg_23_0._privilegeBtn1:setVisible(P._playerBadgeEx2:IsBuyBadge())
	...
	for iter_23_1 = 1, #arg_23_0._freeTask do
		...
		if arg_23_1 > arg_23_0._weekDay then
			...
			var_23_2._btn._taskId = var_23_3._id + 1000

			local var_23_4 = P._playerBadgeEx2._badgeTask[var_23_2._btn._taskId]:getValue()
			...
			if var_23_4 >= var_23_3._value then
				...
				if P._playerBadgeEx2._badgeTask[var_23_2._btn._taskId]:isClaim() then
	...
	for iter_23_2 = 1, #arg_23_0._task do
		...
		if arg_23_1 > arg_23_0._weekDay then
			...
			var_23_5._btn._taskId = var_23_6._id + 1000

			local var_23_7 = P._playerBadgeEx2._badgeTask[var_23_5._btn._taskId]:getValue()
			...
			if P._playerBadgeEx2:IsBuyBadge() then
				if var_23_7 >= var_23_6._value then
					...
					if P._playerBadgeEx2._badgeTask[var_23_5._btn._taskId]:isClaim() then
...
function var_0_0.addBuyArea(arg_24_0)
	...
	local var_24_4 = lc.createSprite("img_gold_badge_ex2")

	lc.addChildToPos(var_24_3, var_24_4, cc.p(lc.w(var_24_3) / 2, lc.h(var_24_3) - lc.ch(var_24_4)))

	local var_24_5 = ClientView.createBMFont(ClientView.BMFont.huali_26, Str(STR.BADGE_SPRING2))
	...
	local var_24_6 = Str(STR.BUY_BADGE_DESC_4, true)
	...
	local var_24_8 = ClientView.createScale9ShaderButton("img_btn_1_s", function(arg_25_0)
		ClientView.startIAP(Data.PurchaseType.badge_ex2)
	end, ClientView.CRECT_BUTTON, 220, 70)

	var_24_8:addLabel(Str(STR.BUY) .. " " .. Str(STR.RMB) .. ClientData.getPrice(Data.PurchaseType.badge_ex2))
	...
	for iter_24_0 = 1, 3 do
		...
		local var_24_11 = "img_little_star_ex2"

		if iter_24_0 == 2 then
			var_24_11 = "img_mid_star_ex2"
		elseif iter_24_0 == 3 then
			var_24_11 = "img_big_star_ex2"
		end
		...
		local var_24_13 = ClientView.createBMFont(ClientView.BMFont.huali_26, string.format(Str(STR.BADGE_EX_STAR2), 30 * Data._globalInfo._springBadgeUpgradeLevel[iter_24_0]))
		...
		local var_24_14 = Str(STR.BUY_STAR_DESC_7, true)

		if iter_24_0 == 2 then
			var_24_14 = Str(STR.BUY_STAR_DESC_8, true)
		elseif iter_24_0 == 3 then
			var_24_14 = Str(STR.BUY_STAR_DESC_9, true)
		end
...
function var_0_0.addHelpArea(arg_27_0)
	local var_27_0 = Data.getHelpStrsByType(Data.HelpType.badge_ex2)
...
function var_0_0.privilegeShow(arg_28_0, arg_28_1, arg_28_2)
	...
	if P:getItemCount(Data.PropsId.badge_extend_task_ex2) > 0 then
		table.insert(var_28_1, var_28_2(Str(STR.PRIVILEGE_DESC_8)))
	end

	if P:getItemCount(Data.PropsId.hall_star_ex2) > 0 then
		table.insert(var_28_1, var_28_2(Str(STR.PRIVILEGE_DESC_9)))
	end

	if P:getItemCount(Data.PropsId.union_star_ex2) > 0 then
		table.insert(var_28_1, var_28_2(Str(STR.PRIVILEGE_DESC_10)))
	end
...
function var_0_0.showTab(arg_32_0, arg_32_1)
	...
	elseif arg_32_1 == 3 then
		...
		arg_32_0._buyStarArea:setVisible(P._playerBadgeEx2:IsBuyBadge())
		arg_32_0._buyBadgeArea:setVisible(not P._playerBadgeEx2:IsBuyBadge())
...
function var_0_0.onClaim(arg_33_0, arg_33_1)
	...
	if var_33_0 == Data.ErrorType.ok then
		...
		lc.sendEvent(Data.Event.badge_reward_ex2)
	end
end

function var_0_0.onClaimAll(arg_34_0)
	local var_34_0 = P._playerBonus._bonusBadgeEx2
	local var_34_1 = {}
...
function var_0_0.onClaimStar(arg_35_0, arg_35_1)
	...
	P._playerBadgeEx2._badgeTask[arg_35_1._taskId]:setClaim(true)

	local var_35_0, var_35_1 = P._playerBadgeEx2:getDayStar(arg_35_1._day)

	arg_35_0._days[arg_35_1._day]._txtObj:setString(var_35_0 .. "/" .. var_35_1)
	ClientData.sendClaimActivityBonus(arg_35_1._taskId)

	local var_35_2 = Data._battlepassTaskEx[arg_35_1._taskId - 1000]._num + P:getItemCount(Data.PropsId.badge_extend_task_ex2) * 6
...
function var_0_0.onBuyBadgeStar(arg_36_0, arg_36_1)
	if P._playerBadgeEx2:getGrade() >= 100 then
	...
	if P:hasResource(Data.ResType.ingot, Data._globalInfo._springBadgeUpgradeIngot[arg_36_1]) then
		...
		ClientData.sendBuyBadgeEx2Star(arg_36_1)
		ToastManager.push(Str(STR.BUYSUCCESS))

		local var_36_0 = Data._globalInfo._springBadgeUpgradeLevel[arg_36_1] * P._playerBadgeEx2:getStarTotal()
...
function var_0_0.onEnter(arg_37_0)
	...
	table.insert(arg_37_0._listeners, lc.addEventListener(Data.Event.badge_reward_ex2, function(arg_38_0)
...
function var_0_0.onCleanup(arg_41_0)
	...
	lc.TextureCache:removeTextureForKey("res/jpg/img_badge_bg_ex2.jpg")
end

function var_0_0.updateBadgeFlag(arg_42_0)
	local var_42_0 = P._playerBadgeEx2:getBadgeClaimFlag()

	ClientView.checkNewFlag(arg_42_0._contentBg._tabs[1], var_42_0, 15, -15)
end

function var_0_0.updateTaskFlag(arg_43_0)
	local var_43_0 = P._playerBadgeEx2:getTaskClaimFlag()
...
function var_0_0.updateTaskTabFlag(arg_44_0)
	for iter_44_0 = 1, #arg_44_0._days do
		...
		local var_44_1 = P._playerBadgeEx2:getOneDayTaskClaimFlag(iter_44_0)
