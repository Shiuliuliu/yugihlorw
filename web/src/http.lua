	...
	return var_0_6.setmetatable({
		...
		__call = function()
			...
			if var_5_2 > 0 then
				...
				arg_2_1, var_5_6 = var_0_9(arg_2_0, arg_2_1)
...
function var_0_8.open(arg_10_0, arg_10_1, arg_10_2)
	...
	var_10_1.try(var_10_0:connect(arg_10_0, arg_10_1 or var_0_8.PORT))

	return var_10_1
end

function var_0_10.__index.sendrequestline(arg_12_0, arg_12_1, arg_12_2)
	local var_12_0 = var_0_4.format("%s %s HTTP/1.1\r\n", arg_12_1 or "GET", arg_12_2)

	return arg_12_0.try(arg_12_0.c:send(var_12_0))
end

function var_0_10.__index.sendheaders(arg_13_0, arg_13_1)
...
function var_0_10.__index.sendbody(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
...
function var_0_10.__index.receivestatusline(arg_15_0)
...
function var_0_10.__index.receiveheaders(arg_16_0)
	return arg_16_0.try(var_0_9(arg_16_0.c))
end

function var_0_10.__index.receivebody(arg_17_0, arg_17_1, arg_17_2, arg_17_3)
...
function var_0_10.__index.receive09body(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
...
function var_0_10.__index.close(arg_19_0)
...
local function var_0_11(arg_20_0)
	...
	if not arg_20_0.proxy and not PROXY then
		var_20_0 = {
...
local function var_0_12(arg_21_0)
	local var_21_0 = arg_21_0.proxy or PROXY
...
local function var_0_15(arg_23_0)
	local var_23_0 = arg_23_0.url and var_0_1.parse(arg_23_0.url, var_0_14) or {}
	...
	var_0_0.try(var_23_0.host and var_23_0.host ~= "", "invalid host '" .. var_0_6.tostring(var_23_0.host) .. "'")

	var_23_0.uri = arg_23_0.uri or var_0_11(var_23_0)
	var_23_0.host, var_23_0.port = var_0_12(var_23_0)
	var_23_0.headers = var_0_13(var_23_0)

	return var_23_0
end

local function var_0_16(arg_24_0, arg_24_1, arg_24_2)
	return arg_24_2.location and var_0_4.gsub(arg_24_2.location, "%s", "") ~= "" and arg_24_0.redirect ~= false and (arg_24_1 == 301 or arg_24_1 == 302 or arg_24_1 == 303 or arg_24_1 == 307) and (not arg_24_0.method or arg_24_0.method == "GET" or arg_24_0.method == "HEAD") and (not arg_24_0.nredirects or arg_24_0.nredirects < 5)
end
...
local function var_0_20(arg_26_0, arg_26_1)
	local var_26_0, var_26_1, var_26_2, var_26_3 = var_0_18({
...
function var_0_18(arg_27_0)
	local var_27_0 = var_0_15(arg_27_0)
	...
	if var_0_16(var_27_0, var_27_2, var_27_6) and not var_27_0.source then
		var_27_1:close()

		return var_0_20(arg_27_0, var_27_6.location)
	end

	if var_0_17(var_27_0, var_27_2) then
...
local function var_0_21(arg_28_0, arg_28_1)
	local var_28_0 = {}
	local var_28_1 = {
		url = arg_28_0,
	...
	local var_28_2, var_28_3, var_28_4 = var_0_0.skip(1, var_0_18(var_28_1))

	return var_0_7.concat(var_28_0), var_28_2, var_28_3, var_28_4
end

var_0_8.request = var_0_0.protect(function(arg_29_0, arg_29_1)
	if var_0_6.type(arg_29_0) == "string" then
		return var_0_21(arg_29_0, arg_29_1)
	else
		return var_0_18(arg_29_0)
	end
end)
