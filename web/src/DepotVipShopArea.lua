local var_0_0 = class("DepotVipShopArea", lc.ExtendCCNode)
...
function var_0_0.init(arg_3_0)
	...
	lc.addChildToPos(arg_3_0, var_3_1, cc.p(lc.cw(arg_3_0), lc.ch(arg_3_0) + 133))
	...
	lc.addChildToPos(arg_3_0, var_3_2, cc.p(lc.cw(arg_3_0), 128))
...
function var_0_0.addCardList(arg_9_0)
	local var_9_0 = var_0_1.create(cc.size(lc.w(arg_9_0), lc.h(arg_9_0)), 0.5, false, 300)

	var_9_0:setAnchorPoint(0.5, 0.5)
	lc.addChildToPos(arg_9_0, var_9_0, cc.p(lc.cw(arg_9_0), lc.ch(arg_9_0) - 25), 2)

	local function var_9_1(arg_10_0)
		local var_10_0 = arg_10_0._card

		ClientData.sendBuyDepot(var_10_0._id)
		P._playerCard:addCard(var_10_0._infoId, 1)
		P:changeResource(var_10_0._priceType, -var_10_0._price)
	...
	local function var_9_2(arg_11_0)
		...
		if P._playerCard:getCardCount(var_11_0._infoId) >= Data.getInfo(var_11_0._infoId)._maxCount then
			return ToastManager.push(Str(STR.SHOP_CARD_MAX))
		end

		local var_11_1 = arg_11_0._card

		if ClientView.checkGold(var_11_1._price) then
	...
	var_9_0:setMode(var_0_1.ModeType.union_shop)

	local var_9_3 = Data._productsExInfo
	local var_9_4 = {}

	for iter_9_0, iter_9_1 in ipairs(var_9_3) do
		if iter_9_1._cost >= 50000 then
			local var_9_5 = iter_9_1._cardId
			local var_9_6, var_9_7, var_9_8, var_9_9 = ClientData.getServerDate()
			local var_9_10 = iter_9_1._date
			local var_9_11 = string.sub(var_9_10, 1, 4)
			local var_9_12 = string.sub(var_9_10, 5, 6)
			local var_9_13 = string.sub(var_9_10, 7, 8)
			local var_9_14 = 12 * (var_9_9 - var_9_11) + (var_9_8 - var_9_12)
			local var_9_15 = true
			...
			if var_9_14 == 0 and var_9_7 - var_9_13 < 0 then
				var_9_15 = false
			end

			if var_9_15 then
				local var_9_16 = Data._globalInfo._magicShopDiscountMonth
				local var_9_17 = 0

				for iter_9_2, iter_9_3 in ipairs(var_9_16) do
					if iter_9_3 <= var_9_14 then
						var_9_17 = iter_9_2
					end

					if var_9_14 <= iter_9_3 then
						break
					end
				end

				local var_9_18 = iter_9_1._cost

				if var_9_5 == 40209 then
					var_9_17 = 0
					var_9_18 = 100000
				elseif var_9_17 > 0 then
					var_9_18 = var_9_18 * Data._globalInfo._magicShopDiscount[var_9_17] / 100
				end

				table.insert(var_9_4, {
					_infoId = var_9_5,
					_price = var_9_18,
					_priceType = iter_9_1._resType,
					_disCount = (var_9_5 == 40209) and 0 or var_9_17,
					_id = iter_9_1._id
				})
			end
		end
	...
	var_9_0._pageLeft._pos = cc.p(-var_9_19, lc.ch(var_9_0))
	var_9_0._pageRight._pos = cc.p(lc.w(var_9_0) + var_9_19, lc.ch(var_9_0))
