...
local var_0_23 = {
	...
	[var_0_18.CPPTYPE_INT64] = var_0_13.Int64ValueChecker(),
	[var_0_18.CPPTYPE_UINT32] = var_0_13.Uint32ValueChecker(),
	[var_0_18.CPPTYPE_UINT64] = var_0_13.Uint64ValueChecker(),
...
local var_0_39 = {
	...
	__newindex = function(arg_27_0, arg_27_1, arg_27_2)
		...
		var_0_30(arg_27_1.cpp_type, arg_27_1.type)(arg_27_2)
...
local function var_0_45(arg_36_0, arg_36_1)
	function arg_36_1._member.ListFields(arg_37_0)
		return (function(arg_38_0)
			local var_38_0, var_38_1, var_38_2 = var_0_5(arg_37_0._fields)

			return function(arg_39_0, arg_39_1)
				while true do
					local var_39_0, var_39_1 = var_38_0(arg_39_0, arg_39_1)

					if var_39_0 == nil then
						return
					elseif var_0_44(var_39_0, var_39_1) then
						return var_39_0, var_39_1
					end
				end
			end, var_38_1, var_38_2
		end)(arg_37_0._fields)
	end
end

local function var_0_46(arg_40_0, arg_40_1)
	local var_40_0 = {}

	for iter_40_0, iter_40_1 in var_0_4(arg_40_0.fields) do
		if iter_40_1.label ~= var_0_18.LABEL_REPEATED then
			var_40_0[iter_40_1.name] = iter_40_1
		end
	end

	function arg_40_1._member.HasField(arg_41_0, arg_41_1)
		field = var_40_0[arg_41_1]

		if field == nil then
			var_0_3("Protocol message has no singular \"" .. arg_41_1 .. "\" field.")
		end

		if field.cpp_type == var_0_18.CPPTYPE_MESSAGE then
			value = arg_41_0._fields[field]

			return value ~= nil and value._is_present_in_parent
		else
			return arg_41_0._fields[field]
		end
	end
end

local function var_0_47(arg_42_0, arg_42_1)
	function arg_42_1._member.ClearField(arg_43_0, arg_43_1)
		if arg_42_0.fields_by_name[arg_43_1] == nil then
			var_0_3("Protocol message has no \"" .. arg_43_1 .. "\" field.")
		end

		if arg_43_0._fields[field] then
			arg_43_0._fields[field] = nil
		end

		arg_42_1._member._Modified(arg_43_0)
	end
end

local function var_0_48(arg_44_0)
	function arg_44_0._member.ClearExtension(arg_45_0, arg_45_1)
		if arg_45_0._fields[arg_45_1] == nil then
			arg_45_0._fields[arg_45_1] = nil
		end

		arg_44_0._member._Modified(arg_45_0)
	end
end

local function var_0_49(arg_46_0, arg_46_1)
	function arg_46_1._member.Clear(arg_47_0)
		arg_47_0._fields = {}

		arg_46_1._member._Modified(arg_47_0)
	end
end

local function var_0_50(arg_48_0)
	local var_48_0 = var_0_19.msg_format

	function arg_48_0.__tostring(arg_49_0)
		return var_48_0(arg_49_0)
	end
end

local function var_0_51(arg_50_0)
	function arg_50_0._member.HasExtension(arg_51_0, arg_51_1)
		if arg_51_1.label == var_0_18.LABEL_REPEATED then
			var_0_3(arg_51_1.full_name .. " is repeated.")
		end

		if arg_51_1.cpp_type == var_0_18.CPPTYPE_MESSAGE then
			value = arg_51_0._fields[arg_51_1]

			return value ~= nil and value._is_present_in_parent
		else
			return arg_51_0._fields[arg_51_1]
		end
	end
end

local function var_0_52(arg_52_0)
	function arg_52_0._member._SetListener(arg_53_0, arg_53_1)
		if arg_53_1 ~= nil then
			arg_53_0._listener = var_0_16.NullMessageListener()
		else
			arg_53_0._listener = arg_53_1
		end
	end
end

local function var_0_53(arg_54_0, arg_54_1)
	function arg_54_1._member.ByteSize(arg_55_0)
		if not arg_55_0._cached_byte_size_dirty then
			return arg_55_0._cached_byte_size
		end

		local var_55_0 = 0

		for iter_55_0, iter_55_1 in arg_54_1._member.ListFields(arg_55_0) do
			var_55_0 = iter_55_0._sizer(iter_55_1) + var_55_0
		end

		arg_55_0._cached_byte_size = var_55_0
		arg_55_0._cached_byte_size_dirty = false
		arg_55_0._listener_for_children.dirty = false

		return var_55_0
	end
end

local function var_0_54(arg_56_0, arg_56_1)
	function arg_56_1._member.SerializeToString(arg_57_0)
		if not arg_56_1._member.IsInitialized(arg_57_0) then
			var_0_3("Message is missing required fields: " .. var_0_7.concat(arg_56_1._member.FindInitializationErrors(arg_57_0), ","))
		end

		return arg_56_1._member.SerializePartialToString(arg_57_0)
	end

	function arg_56_1._member.SerializeToIOString(arg_58_0, arg_58_1)
		if not arg_56_1._member.IsInitialized(arg_58_0) then
			var_0_3("Message is missing required fields: " .. var_0_7.concat(arg_56_1._member.FindInitializationErrors(arg_58_0), ","))
		end

		return arg_56_1._member.SerializePartialToIOString(arg_58_0, arg_58_1)
	end
end

local function var_0_55(arg_59_0, arg_59_1)
	local var_59_0 = var_0_7.concat

	local function var_59_1(arg_60_0, arg_60_1)
		for iter_60_0, iter_60_1 in arg_59_1._member.ListFields(arg_60_0) do
			iter_60_0._encoder(arg_60_1, iter_60_1)
		end
	end

	local function var_59_2(arg_61_0, arg_61_1)
		local var_61_0 = arg_61_1.write

		local function var_61_1(arg_62_0)
			var_61_0(arg_61_1, arg_62_0)
		end

		var_59_1(arg_61_0, var_61_1)
	end

	local function var_59_3(arg_63_0)
		local var_63_0 = {}

		local function var_63_1(arg_64_0)
			var_63_0[#var_63_0 + 1] = arg_64_0
		end

		var_59_1(arg_63_0, var_63_1)

		return var_59_0(var_63_0)
	end

	arg_59_1._member._InternalSerialize = var_59_1
	arg_59_1._member.SerializePartialToIOString = var_59_2
	arg_59_1._member.SerializePartialToString = var_59_3
end

local function var_0_56(arg_65_0, arg_65_1)
	local var_65_0 = var_0_15.ReadTag
	local var_65_1 = var_0_15.SkipField
	local var_65_2 = arg_65_1._decoders_by_tag

	local function var_65_3(arg_66_0, arg_66_1, arg_66_2, arg_66_3)
		arg_65_1._member._Modified(arg_66_0)

		local var_66_0 = arg_66_0._fields
		local var_66_1
		local var_66_2
		local var_66_3

		while arg_66_2 ~= arg_66_3 do
			local var_66_4, var_66_5 = var_65_0(arg_66_1, arg_66_2)
			local var_66_6 = var_65_2[var_66_4]

			if var_66_6 == nil then
				var_66_5 = var_65_1(arg_66_1, var_66_5, arg_66_3, var_66_4)
				...
				arg_66_2 = var_66_6(arg_66_1, var_66_5, arg_66_3, arg_66_0, var_66_0)
			end
		end
	...
	arg_65_1._member._InternalParse = var_65_3

	local function var_65_4(arg_67_0, arg_67_1)
		local var_67_0 = #arg_67_1

		if var_65_3(arg_67_0, arg_67_1, 0, var_67_0) ~= var_67_0 then
	...
	arg_65_1._member.MergeFromString = var_65_4

	function arg_65_1._member.ParseFromString(arg_68_0, arg_68_1)
		arg_65_1._member.Clear(arg_68_0)
		var_65_4(arg_68_0, arg_68_1)
	end
end

local function var_0_57(arg_69_0, arg_69_1)
	local var_69_0 = {}

	for iter_69_0, iter_69_1 in var_0_4(arg_69_0.fields) do
		if iter_69_1.label == var_0_18.LABEL_REQUIRED then
			var_69_0[#var_69_0 + 1] = iter_69_1
		end
	end

	function arg_69_1._member.IsInitialized(arg_70_0, arg_70_1)
		for iter_70_0, iter_70_1 in var_0_4(var_69_0) do
			if arg_70_0._fields[iter_70_1] == nil or iter_70_1.cpp_type == var_0_18.CPPTYPE_MESSAGE and not arg_70_0._fields[iter_70_1]._is_present_in_parent then
				if arg_70_1 ~= nil then
					arg_70_1[#arg_70_1 + 1] = arg_69_1._member.FindInitializationErrors(arg_70_0)
				end
		...
		for iter_70_2, iter_70_3 in var_0_5(arg_70_0._fields) do
			if iter_70_2.cpp_type == var_0_18.CPPTYPE_MESSAGE then
				if iter_70_2.label == var_0_18.LABEL_REPEATED then
					for iter_70_4, iter_70_5 in var_0_4(iter_70_3) do
						if not iter_70_5:IsInitialized() then
							if arg_70_1 ~= nil then
								arg_70_1[#arg_70_1 + 1] = arg_69_1._member.FindInitializationErrors(arg_70_0)
							end
				...
				elseif iter_70_3._is_present_in_parent and not iter_70_3:IsInitialized() then
					if arg_70_1 ~= nil then
						arg_70_1[#arg_70_1 + 1] = arg_69_1._member.FindInitializationErrors(arg_70_0)
					end
	...
	function arg_69_1._member.FindInitializationErrors(arg_71_0)
		local var_71_0 = {}

		for iter_71_0, iter_71_1 in var_0_4(var_69_0) do
			if not arg_69_1._member.HasField(arg_71_0, iter_71_1.name) then
				var_71_0.append(iter_71_1.name)
			end
		end

		for iter_71_2, iter_71_3 in arg_69_1._member.ListFields(arg_71_0) do
			if iter_71_2.cpp_type == var_0_18.CPPTYPE_MESSAGE then
				if iter_71_2.is_extension then
					name = io:format("(%s)", iter_71_2.full_name)
				else
					name = iter_71_2.name
				end

				if iter_71_2.label == var_0_18.LABEL_REPEATED then
					for iter_71_4, iter_71_5 in var_0_4(iter_71_3) do
						prefix = io:format("%s[%d].", name, iter_71_4)
						sub_errors = iter_71_5:FindInitializationErrors()

						for iter_71_6, iter_71_7 in var_0_4(sub_errors) do
							var_71_0[#var_71_0 + 1] = prefix .. iter_71_7
						end
					end
				else
					prefix = name .. "."
					sub_errors = iter_71_3:FindInitializationErrors()

					for iter_71_8, iter_71_9 in var_0_4(sub_errors) do
						var_71_0[#var_71_0 + 1] = prefix .. iter_71_9
					end
				end
			end
		end
...
local function var_0_58(arg_72_0)
	local var_72_0 = var_0_18.LABEL_REPEATED
	local var_72_1 = var_0_18.CPPTYPE_MESSAGE

	function arg_72_0._member.MergeFrom(arg_73_0, arg_73_1)
		assert(arg_73_1 ~= arg_73_0)
		arg_72_0._member._Modified(arg_73_0)

		local var_73_0 = arg_73_0._fields

		for iter_73_0, iter_73_1 in var_0_5(arg_73_1._fields) do
			if iter_73_0.label == var_72_0 or iter_73_0.cpp_type == var_72_1 then
				field_value = var_73_0[iter_73_0]

				if field_value == nil then
					field_value = iter_73_0._default_constructor(arg_73_0)
					var_73_0[iter_73_0] = field_value
				end

				field_value:MergeFrom(iter_73_1)
			else
				arg_73_0._fields[iter_73_0] = iter_73_1
			end
		end
	end
end

local function var_0_59(arg_74_0, arg_74_1)
	var_0_45(arg_74_0, arg_74_1)
	var_0_46(arg_74_0, arg_74_1)
	var_0_47(arg_74_0, arg_74_1)

	if arg_74_0.is_extendable then
		var_0_48(arg_74_1)
		var_0_51(arg_74_1)
	end

	var_0_49(arg_74_0, arg_74_1)
	var_0_50(arg_74_1)
	var_0_52(arg_74_1)
	var_0_53(arg_74_0, arg_74_1)
	var_0_54(arg_74_0, arg_74_1)
	var_0_55(arg_74_0, arg_74_1)
	var_0_56(arg_74_0, arg_74_1)
	var_0_57(arg_74_0, arg_74_1)
	var_0_58(arg_74_1)
end

local function var_0_60(arg_75_0)
	local function var_75_0(arg_76_0)
		if not arg_76_0._cached_byte_size_dirty then
			arg_76_0._cached_byte_size_dirty = true
			arg_76_0._listener_for_children.dirty = true
			arg_76_0._is_present_in_parent = true

			arg_76_0._listener:Modified()
		end
	end

	arg_75_0._member._Modified = var_75_0
	arg_75_0._member.SetInParent = var_75_0
end

local function var_0_61(arg_77_0)
	local var_77_0 = arg_77_0._getter
	local var_77_1 = arg_77_0._member

	return function(arg_78_0, arg_78_1)
		local var_78_0 = var_77_0[arg_78_1]

		if var_78_0 then
			return var_78_0(arg_78_0)
		else
			return var_77_1[arg_78_1]
		end
	end
end

local function var_0_62(arg_79_0)
	local var_79_0 = arg_79_0._setter

	return function(arg_80_0, arg_80_1, arg_80_2)
		local var_80_0 = var_79_0[arg_80_1]

		if var_80_0 then
			var_80_0(arg_80_0, arg_80_2)
		else
			var_0_3(arg_80_1 .. " not found")
		end
	end
end

function _AddClassAttributesForNestedExtensions(arg_81_0, arg_81_1)
	local var_81_0 = arg_81_0._extensions_by_name

	for iter_81_0, iter_81_1 in var_0_5(var_81_0) do
		arg_81_1._member[iter_81_0] = iter_81_1
	end
end
...
local function var_0_63(arg_82_0)
	...
	var_0_1(arg_82_0, "_extensions_by_name", {})

	for iter_82_0, iter_82_1 in var_0_4(arg_82_0.extensions) do
		arg_82_0._extensions_by_name[iter_82_1.name] = iter_82_1
	end

	var_0_1(arg_82_0, "_extensions_by_number", {})

	for iter_82_2, iter_82_3 in var_0_4(arg_82_0.extensions) do
		arg_82_0._extensions_by_number[iter_82_3.number] = iter_82_3
	end

	var_82_0._descriptor = arg_82_0
	var_82_0._extensions_by_name = {}
	var_82_0._extensions_by_number = {}
	var_82_0._getter = {}
	var_82_0._setter = {}
	var_82_0._member = {}

	local var_82_1 = var_0_0({}, var_82_0._member)

	var_82_0._member.__call = var_0_34(var_82_0)
	var_82_0._member.__index = var_82_0._member
	var_82_0._member.type = var_82_1

	if var_0_2(arg_82_0, "_concrete_class") == nil then
		var_0_1(arg_82_0, "_concrete_class", var_82_1)

		for iter_82_4, iter_82_5 in var_0_4(arg_82_0.fields) do
			var_0_32(var_82_0, iter_82_5)
		end
	end

	var_0_33(arg_82_0, var_82_0)
	_AddClassAttributesForNestedExtensions(arg_82_0, var_82_0)
	var_0_41(arg_82_0, var_82_0)
	var_0_42(arg_82_0, var_82_0)
	var_0_43(var_82_0)
	var_0_59(arg_82_0, var_82_0)
	var_0_60(var_82_0)

	var_82_0.__index = var_0_61(var_82_0)
	var_82_0.__newindex = var_0_62(var_82_0)
