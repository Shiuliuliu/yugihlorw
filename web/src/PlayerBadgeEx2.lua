local var_0_0 = class("PlayerBadgeEx2")
...
function var_0_0.init(arg_4_0, arg_4_1)
	arg_4_0._grade = arg_4_1.spring2_badge_level
	arg_4_0._isBuyBadge = arg_4_1.spring2_badge_purchased
	arg_4_0._starNum = arg_4_1.spring2_badge_exp
	arg_4_0._starTotal = Data._globalInfo._springBadgeExpPerLevel
	arg_4_0._curStage = arg_4_1.spring2_badge_season or 1
	arg_4_0._endTime = arg_4_1.spring2_badge_end_timestamp / 1000
...
function var_0_0.refreshBonusValue(arg_5_0)
	for iter_5_0 = 1, #P._playerBonus._bonusBadgeEx2 do
		P._playerBonus._bonusBadgeEx2[iter_5_0]:setValue(arg_5_0._grade)
	end
end
...
function var_0_0.getDayStar(arg_15_0, arg_15_1)
	...
	for iter_15_0, iter_15_1 in pairs(Data._battlepassTaskEx) do
		if tonumber(iter_15_1._releaseDay) == tonumber(arg_15_1) then
			if arg_15_0._badgeTask[iter_15_0 + 1000]:isClaim() then
...
function var_0_0.getBadgeClaimFlag(arg_18_0)
	for iter_18_0 = 1, #P._playerBonus._bonusBadgeEx2 do
		local var_18_0 = P._playerBonus._bonusBadgeEx2[iter_18_0]
		...
		elseif var_18_1 == 63 and arg_18_0:IsBuyBadge() and var_18_0:canClaim() then
			return true
		end
	end
