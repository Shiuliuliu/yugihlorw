local var_0_0 = class("DiamondShopArea", lc.ExtendCCNode)
...
function var_0_0.generateCardPackageData(arg_6_0)
	local var_6_0 = Data._diamondProductsInfo
	local var_6_1 = {}
	local var_6_2 = {}
	...
	for iter_6_0, iter_6_1 in ipairs(var_6_0) do
		...
		if iter_6_1._id == 209 then
			local var_6_4 = 0
			local var_6_5 = 0
		end

		if not (P:getCharacterUnlockCount() < 2) or not (var_6_3 > 1020) then
			...
			local var_6_7 = iter_6_1._cardId
			local var_6_8, var_6_9, var_6_10, var_6_11 = ClientData.getServerDate()
			local var_6_12 = iter_6_1._date
			local var_6_13 = string.sub(var_6_12, 1, 4)
			local var_6_14 = string.sub(var_6_12, 5, 6)
			local var_6_15 = string.sub(var_6_12, 7, 8)
			local var_6_16 = 12 * (var_6_11 - var_6_13) + (var_6_10 - var_6_14)
			local var_6_17 = true
			...
			if var_6_16 == 0 and var_6_9 - var_6_15 < 0 then
				var_6_17 = false
			end

			if var_6_17 then
				local var_6_18 = iter_6_1._cost

				table.insert(var_6_1[var_6_3], 1, {
					_infoId = var_6_7,
					_price = var_6_18,
...
function var_0_0.createRecruitItem(arg_8_0, arg_8_1)
	...
	local var_8_1 = ClientView.createDiamondCardPackage(arg_8_1)
...
function var_0_0.isLocked(arg_10_0, arg_10_1)
	...
	local var_10_1 = ""
	local var_10_2 = arg_10_1._type * 100 + 1

	if var_10_2 == 103001 and P:getCharacterUnlockCount() < 2 then
		var_10_0 = true
		var_10_1 = string.format(Str(STR.NEED_UNLOCK_CHARACTER_COUNT), 2)
	elseif var_10_2 == 104001 and P:getCharacterUnlockCount() < 2 then
		var_10_0 = true
		var_10_1 = string.format(Str(STR.NEED_UNLOCK_CHARACTER_COUNT), 2)
	end
...
function var_0_0.showCardBox(arg_14_0, arg_14_1)
	...
	ClientView.getResourceUI():setMode(Data.PropsId.times_package_ticket, 2)
end
...
function var_0_0.addCardList(arg_18_0, arg_18_1, arg_18_2)
	...
	local function var_18_4(arg_19_0)
		...
		if var_19_0._price > P:getItemCount(var_19_0._priceType) then
			if var_19_0._priceType == Data.PropsId.times_package_ticket then
				...
				return ToastManager.push(string.format(Str(STR.NOT_ENOUGH), Str(Data._propsInfo[var_19_0._priceType]._nameSid)))
			end
		end

		ClientData.sendBuyDiamond(var_19_0._id)
	...
	var_18_3:setMode(var_0_1.ModeType.diamond_shop)
	...
	lc.addChildToPos(arg_18_0._cardList, var_18_7, cc.p(0, lc.ch(var_18_7) + 50), -1)
