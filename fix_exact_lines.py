...
DIRECT_MAPS = {
    ...
    # Event description (USE LITERAL \\n so it wraps cleanly in game without creating new file lines):
...
for i, line in enumerate(lines):
    ...
    # Materials:
    l = sub_line(r"vật liệu tổng hợp", "nguyên liệu Dung Hợp", l)
    l = sub_line(r"tài liệu đồng bộ", "nguyên liệu Đồng Điệu", l)
    l = sub_line(r"vật liệu thừa", "nguyên liệu Siêu Lượng", l)
    l = sub_line(r"vật liệu kết nối", "nguyên liệu Liên Kết", l)
    l = sub_line(r"Quái Thú con lắc", "Quái Thú Dao Động", l)
    l = sub_line(r"từ chối sự tương đồng", "Phân Tách Đồng Điệu (De-Synchro)", l)
    ...
    l = sub_line(r"kết nối đấu tay đôi", "Quyết Đấu Kết Nối (Link Duel)", l, flags=re.I)
    ...
    # Ensure no internal newline was created
