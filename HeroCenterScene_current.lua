...
function var_0_1.releaseToopList(arg_24_0)
	local var_24_0 = arg_24_0._troopList:getItems()

	for iter_24_0, iter_24_1 in ipairs(var_24_0) do
		var_0_3.releaseToPool(iter_24_1._item)
		iter_24_1:release()
	end
...
function var_0_1.remainItemFromList(arg_25_0, arg_25_1)
	local var_25_0 = {}
	local var_25_1 = arg_25_0._troopList:getItems()
...
function var_0_1.onItemPress(arg_44_0, arg_44_1, arg_44_2)
	...
	if arg_44_2 == var_0_1.MODE_UNTROOP and arg_44_0._troopList and arg_44_0._troopList.setIsScrollEnabled then
		arg_44_0._troopList:setIsScrollEnabled(false)
	end
end
...
function var_0_1.onItemMove(arg_45_0, arg_45_1, arg_45_2)
	...
	if arg_45_0._movingSprite == nil then
		if arg_45_0._movingDir == var_0_12.none then
			local delta = cc.pSub(arg_45_1:getTouchMovePosition(), arg_45_1:getTouchBeganPosition())
			local var_45_0 = math.abs(delta.x)
			local var_45_1 = math.abs(delta.y)

			if arg_45_2 == var_0_1.MODE_UNTROOP then
				if delta.y > 2 or (var_45_1 > 4 and var_45_1 >= var_45_0 * 0.3) then
	...
	if arg_45_0._movingSprite then
		arg_45_0._movingSprite:setPosition(cc.pAdd(arg_45_0._movingSprite._srcPos, cc.pSub(arg_45_1:getTouchMovePosition(), arg_45_1:getTouchBeganPosition())))
...
function var_0_1.onItemTap(arg_46_0, arg_46_1, arg_46_2)
	...
	if arg_46_2 == var_0_1.MODE_TROOP then
		if arg_46_0._movingSprite and arg_46_0._isInList then
	...
	elseif arg_46_2 == var_0_1.MODE_UNTROOP and arg_46_0._movingSprite and arg_46_0._isInList then
		var_46_4._isDirty = true
		...
		arg_46_0:playAction(var_46_1, false, arg_46_0._movingSprite._srcPos)
	end
...
function var_0_1.onTroopTouchThumbnail(arg_47_0, arg_47_1, arg_47_2)
	...
	if arg_47_2 == ccui.TouchEventType.began then
		...
		if arg_47_0._troopList and arg_47_0._troopList.setIsScrollEnabled then
			arg_47_0._troopList:setIsScrollEnabled(false)
		end
...
function var_0_1.onTroopThumbnailSelected(arg_48_0, arg_48_1)
	if arg_48_1 ~= nil then
		...
		local var_48_1 = {}
		local var_48_2 = 0
		local var_48_3 = arg_48_0._troopList:getItems()

		for iter_48_0 = 1, #var_48_3 do
			local var_48_4 = var_48_3[iter_48_0]._item._thumbnail
...
function var_0_1.checkList(arg_55_0, arg_55_1)
	...
	if var_55_0 then
		...
		arg_55_0._isInList = (arg_55_0._separatorPos < lc.y(var_55_2)) or (lc.y(var_55_2) > 190)
	end
end
...
function var_0_1.getTroopItem(arg_64_0, arg_64_1)
	local var_64_0 = arg_64_0._troopList:getItems()

	for iter_64_0 = 1, #var_64_0 do
		local var_64_1 = var_64_0[iter_64_0]._item
		local var_64_2 = var_64_1._thumbnail
